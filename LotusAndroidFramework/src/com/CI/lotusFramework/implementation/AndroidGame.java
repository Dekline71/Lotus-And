...
/**
 * Base game activity class that extends androids Activity class
...
public abstract class AndroidGame extends Activity implements Game 
{
   ...
   public static Graphics g;
    ...
    /* 
     * First called method from Activity Lifecycle
     * - screen layouts/ resolution based on device are set 
    */
    @Override
